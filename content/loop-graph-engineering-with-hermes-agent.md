...
![The durable operating chain is event, company object, business problem, route commit, run attempt, and observed outcome](paper-operating-objects-v3.png)
...
![The Connector Broker provides bounded access, Hermes provides semantic judgment, and Loopgraph provides deterministic authority](paper-three-trust-layers-v3.png)
...
![A loop progresses from simulation to shadow, recommendation, approval-bound execution, and bounded low-risk autonomy](paper-autonomy-ladder-v3.png)
