-- Bind every new App uninstall journal entry to the exact source installation,
-- ownership graph, LoopSpec inventory, accountable actor, and reason digest.
-- Legacy completed uninstall entries remain readable, while the runtime refuses
-- to automatically resume a legacy unfinished entry without this intent.
        ...
        or exists (
          ...
          where jsonb_typeof(item.value) is distinct from 'object'
            or item.value - array[
              ...
              'targetArtifactDigest', 'status', 'desired', 'activation', 'rollout', 'uninstall', 'actor',
