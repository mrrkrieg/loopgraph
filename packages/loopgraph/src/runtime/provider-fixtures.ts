...
export const PROVIDER_GOLDEN_FIXTURES: ProviderGoldenFixture[] = [
  ...
  { providerId: "bigquery", deliveryId: "bigquery-window-1", payload: { id: "metric-window-1", eventType: "management.company_metric_anomaly", occurredAt: "2026-08-13T00:00:00.000Z", metric: { id: "qualified-pipeline", baseline: 120, current: 82, materialityThreshold: 15 } }, expectedEventType: "management.company_metric_anomaly", expectedSubjectType: "company_metric_anomaly" },
  { providerId: "snowflake", deliveryId: "snowflake-window-1", payload: { id: "forecast-window-1", eventType: "finance.forecast_variance_detected", occurredAt: "2026-08-13T00:00:00.000Z", forecast: { id: "fy27-q1-v4", baseline: 2400000, current: 2100000, currency: "USD" } }, expectedEventType: "finance.forecast_variance_detected", expectedSubjectType: "forecast_window" }
];
