...
export const HERMES_LOOPGRAPH_INTEGRATION_VERSION = "hermes-loopgraph/v1alpha13" as const;
export const HERMES_ACTIVATION_RECEIPT_SCHEMA_VERSION = "hermes-loopgraph-activation/v1alpha2" as const;
export const HERMES_LOOPGRAPH_SKILL_VERSION = "0.12.0" as const;
export const HERMES_LOOPGRAPH_MCP_PROTOCOL_VERSION = "loopgraph-mcp/v1alpha10" as const;
export const HERMES_LOOPGRAPH_DESIGN_SKILL_PROTOCOL_VERSION = "loopgraph-design-skill/v1alpha8" as const;
export const HERMES_LOOPGRAPH_EVENT_ROUTER_SKILL_PROTOCOL_VERSION = "loopgraph-event-router-skill/v1alpha2" as const;
...
5. Read the returned \`learningContext\`. It contains only bounded routing evaluations, human corrections, observed outcomes, and net-value evidence for eligible and subject-related loops. Its authority is advisory: unavailable evidence stays unknown, and historical success can never make an ineligible loop eligible.
...
- MCP resources: \`loopgraph://schemas/event-envelope\`, \`loopgraph://schemas/routing-card\`, \`loopgraph://schemas/routing-decision\`, \`loopgraph://schemas/routing-learning-context\`, and \`loopgraph://graph/company\`. Do not read full loop resources from an untrusted webhook turn.
