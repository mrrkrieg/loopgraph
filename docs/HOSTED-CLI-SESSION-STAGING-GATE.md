...
`audit-drain/v6` proof into `loopgraph-production-promotion-evidence/v14`. Production re-reads the
...
proved by the separate `cli-admin-staging` protected job and bound into the same v14 manifest.
