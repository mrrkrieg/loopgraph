...
Apply `202608010001_enterprise_connector_broker.sql` and `202608100001_expand_connector_broker_providers.sql`, configure provider callback URLs, and validate
