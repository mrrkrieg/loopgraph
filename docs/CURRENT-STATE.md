...
7. Configure the protected App evidence-health staging workload identities and run
   ...
   present; the first deployment-specific receipt and independent invalid/expired/renew-soon
   fixture rehearsal remain external.
